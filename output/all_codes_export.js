export AllGcodesDate = new Date(2026, 8, 1, 18, 16, 23);
export default const AllGcodes = {
  ...
  "M140": [
    ...
    },
    {
      ...
      "parameters": [
        {
          "description": " Bed heater slot index",
          "label": "Pnnn",
          "optional": true,
          "tag": "P",
          "values": []
  ...
  "M147": [
    {
      ...
      "related": [],
      "source": "RepRap",
      "title": "M147: Set Filtration Required for Current Print",
      "url": "https://reprap.org/wiki/G-code#M147:_Set_Filtration_Required_for_Current_Print"
    }
  ],
  "M148": [
    {
      ...
      "related": [],
      "source": "RepRap",
      "title": "M148: Disable Filtration for Current Print",
      "url": "https://reprap.org/wiki/G-code#M148:_Disable_Filtration_for_Current_Print"
    }
  ],
  "M149": [
    {
  ...
  "M26": [
    ...
    },
    {
      ...
      "parameters": [
        ...
        {
          "description": " (Optional, RepRapFirmware 3.7 and later only) The G0/G1/G2/G3 command that was in effect at the specified file position, 0 to 3",
          "label": "Cn",
          "optional": true,
          "tag": "C",
          "values": []
  ...
  "M420": [
    {
      ...
      "parameters": [
        ...
        {
          "description": "- Re-center the all mesh Z values, then subtract the given negative offset (default 0).\n   - UBL: Center on the Mean Average (sum / count).\n   - Others: Center on the Midrange ((highest - lowest) / 2).\n- Works only with a valid mesh.\n",
          "label": "[C<float|negative_offset>]",
          "optional": true,
          "requires": "HAS_MESH",
          "tag": "C",
          "values": [
  ...
  "M556": [
    ...
    },
    {
      ...
      "parameters": [
        {
          "description": " Set bedlet based on X coordinate",
          "label": "Xnnn",
          "optional": true,
          "tag": "X",
          "values": []
        ...
        {
          "description": " Set bedlet based on Y coordinate",
          "label": "Ynnn",
          "optional": true,
          "tag": "Y",
          "values": []
        ...
        {
          "description": " Set bedlet based on it's index",
          "label": "Innn",
          "optional": true,
          "tag": "I",
          "values": []
      ...
      "related": [],
      "source": "RepRap",
      "title": "M556: Override modular bedlet active",
      "url": "https://reprap.org/wiki/G-code#M556:_Override_modular_bedlet_active"
    }
  ],
  "M557": [
    {
    ...
    },
    {
      ...
      "parameters": [
        {
          "description": " Set gradient cutoff",
          "label": "Cnnn",
          "optional": true,
          "tag": "C",
          "values": []
        ...
        {
          "description": " Set gradient exponent",
          "label": "Ennn",
          "optional": true,
          "tag": "E",
          "values": []
      ...
      "related": [],
      "source": "RepRap",
      "title": "M557: Set modular bed",
      "url": "https://reprap.org/wiki/G-code#M557:_Set_modular_bed"
    }
  ],
  "M558": [
    {
  ...
  "M564": [
    {
      ...
      "parameters": [
        ...
        {
          "description": " R1 = clamp relative moves that exceed the axis boundaries to those boundaries (default), R0 = throw an error instead (RepRapFirmware 3.7 and later only)",
          "label": "Rnnn",
          "optional": true,
          "tag": "R",
          "values": []
  ...
  "M569.1": [
    {
      ...
      "parameters": [
        ...
        {
          "description": " Encoder type: 0=none (default), 1=linear quadrature encoder plus Duet3D magnetic shaft encoder, 2=quadrature encoder on motor shaft, 3=Duet3D magnetic shaft encoder",
          "label": "Tn",
          "optional": true,
          "tag": "T",
          "values": []
        ...
        {
          "description": " Quadrature encoder pulses per revolution, for encoder types 1 and 2 only. Not required for a magnetic shaft encoder",
          "label": "Cn.n",
          "optional": true,
          "tag": "C",
          "values": []
        ...
        {
          "description": " Position error thresholds in full motor steps. Exceeding m.m is reported as a driver error, exceeding n.n as a driver warning. Default 2.0:4.0, and a threshold of zero disables that report",
          "label": "En.n:m.m",
          "optional": true,
          "tag": "E",
          "values": []
        ...
        {
          "description": " Motor full steps per revolution, default 200 (RepRapFirmware 3.5 and later only)",
          "label": "Sn",
          "optional": true,
          "tag": "S",
          "values": []
        ...
        {
          "description": " Velocity feedforward constant (RepRapFirmware 3.5 and later only)",
          "label": "Vn.n",
          "optional": true,
          "tag": "V",
          "values": []
        ...
        {
          "description": " Acceleration feedforward constant (RepRapFirmware 3.5 and later only)",
          "label": "An.n",
          "optional": true,
          "tag": "A",
          "values": []
        ...
        {
          "description": " Position error deadband in full steps. While no movement is commanded, position errors up to this value are ignored by the closed loop controller so that it does not react to encoder noise at standstill; larger errors are corrected as normal. By default the deadband is set automatically to the spacing of one encoder count; a positive value overrides this, B0 disables the deadband, and a negative value restores the automatic setting (RepRapFirmware after 3.7.0-beta.3)",
          "label": "Bn.n",
          "optional": true,
          "tag": "B",
          "values": []
        ...
        {
          "description": " Motor torque in newton-metres per amp of peak motor current, needed only when the driver is used in torque mode, see M569.4 (RepRapFirmware 3.5 and later only)",
          "label": "Qn.n",
          "optional": true,
          "tag": "Q",
          "values": []
        ...
        {
          "description": " Type of magnetic encoder, only relevant for encoder types 1 and 3, default \"as5047d\" (RepRapFirmware 3.6.2 and later only)",
          "label": "Y\"type\"",
          "optional": true,
          "tag": "Y",
          "values": []
        ...
        {
          "description": " Minimum holding current as a percentage of the configured current when operating in closed loop mode (RepRapFirmware 3.5 and earlier only)",
          "label": "Hn",
          "optional": true,
          "tag": "H",
          "values": []
  ...
  "M569.2": [
    {
      ...
      "parameters": [
        ...
        {
          "description": " Harmonic of the electrical cycle to correct, must be a multiple of 4 (4, 8, 12 or 16) (RepRapFirmware after 3.7.0-beta.3 only)",
          "label": "Snn",
          "optional": true,
          "tag": "S",
          "values": []
        ...
        {
          "description": " Correction magnitude in degrees, 0 to 90. J0 removes the correction for that harmonic (RepRapFirmware after 3.7.0-beta.3 only)",
          "label": "Jnnn",
          "optional": true,
          "tag": "J",
          "values": []
        ...
        {
          "description": " Correction phase in degrees, 0 or 180, default 0 (RepRapFirmware after 3.7.0-beta.3 only)",
          "label": "Onnn",
          "optional": true,
          "tag": "O",
          "values": []
  ...
  "M591": [
    {
      "brief": "This configures filament sensing for the specified extruder. The sensor may be a simple filament presence detector, or a device that measures movement of filament, or both. The action on detecting a filament error is firmware-dependent, but would typically be to run a macro and/or to pause the print and display a message. In RepRapFirmware 3.7.0-beta.3 and later, monitors that can detect filament presence report it in the object model as sensors.filamentMonitors[].filamentPresent, and the presence and motion indications are available as virtual general purpose input ports, see M950.",
      "codes": [
        "M591"
      ],
      "id": "RepRap.M591[0]",
  ...
  "M603": [
    ...
    {
      "brief": "This command configures Filament Change behavior in Marlin Firmware and in Prusa Buddy firmware.",
      "codes": [
        "M603"
      ],
      "id": "RepRap.M603[1]",
  ...
  "M701": [
    ...
    },
    {
      ...
      "parameters": [
        {
          "description": " Name of  Filament to load, for example S\"PLA\" (RepRapFirmware/Buddy)",
          "label": "Snn",
          "optional": true,
          "tag": "S",
          "values": []
        ...
        {
          "description": " Tool to load (Marlin/Prusa/Buddy)",
          "label": "Tnn",
          "optional": true,
          "tag": "T",
          "values": []
        ...
        {
          "description": " Length to use for load (Marlin/Prusa/Buddy)",
          "label": "Lnn",
          "optional": true,
          "tag": "L",
          "values": []
        ...
        {
          "description": " Z raise to perform (Marlin/Prusa/Buddy)",
          "label": "Znn",
          "optional": true,
          "tag": "Z",
          "values": []
        ...
        {
          "description": " index of multi-material slot, zero-indexed (Buddy)",
          "label": "Pnn",
          "optional": true,
          "tag": "P",
          "values": []
        ...
        {
          "description": " Extruder number, required for mixing extruder.Also extruder index such as on Prusa XL (for example, if using Prusa XL with 5 MMUs connected, both could be used in the form  M701 T4 P4 (Buddy)",
          "label": "Tnn",
          "optional": true,
          "tag": "T",
          "values": []
  ...
  "M702": [
    ...
    },
    {
      ...
      "parameters": [
        {
          "description": " Tool to load (Marlin & Buddy)",
          "label": "Tnn",
          "optional": true,
          "tag": "T",
          "values": []
        ...
        {
          "description": " Length to use for unload (Marlin & Prusa & Buddy Firmware)",
          "label": "Unn",
          "optional": true,
          "tag": "U",
          "values": []
        ...
        {
          "description": " Z raise to perform (Marlin & Prusa * Buddy Firmware)",
          "label": "Znn",
          "optional": true,
          "tag": "Z",
          "values": []
        ...
        {
          "description": " Preheat behavior: W'-1': default, no preheat; W0: preheat no return no cool down; W1: preheat with cool down option; W2: preheat with return option; W3: preheat with cool down and return options (Buddy)",
          "label": "Wnn",
          "optional": true,
          "tag": "W",
          "values": []
        ...
        {
          "description": " Ask if the cooldown was successful",
          "label": "I",
          "optional": true,
          "tag": "I",
          "values": []
  ...
  "M863": [
    ...
    },
    {
      ...
      "related": [],
      "source": "RepRap",
      "title": "M863: Tool Remapping",
      "url": "https://reprap.org/wiki/G-code#M863:_Tool_Remapping"
    }
  ],
  "M864": [
    {
  ...
  "M870": [
    {
      "brief": "M870 Opens or closes the automatic chamber vent, such as on the Prusa Core One+ and Core One L.",
      "codes": [
        "M870"
      ],
      "id": "RepRap.M870[0]",
      ...
      "related": [],
      "source": "RepRap",
      "title": "M870: Open/Close Automatic Chamber Vent",
      "url": "https://reprap.org/wiki/G-code#M870:_Open.2FClose_Automatic_Chamber_Vent"
    }
  ],
  "M871": [
    {
  ...
  "M920": [
    {
      ...
      "url": "https://marlinfw.org/docs/gcode/M920"
    },
    {
  ...
  "M959": [
    {
      ...
      "related": [],
      "source": "RepRap",
      "title": "M959: Configure CAN expansion board behaviour",
      "url": "https://reprap.org/wiki/G-code#M959:_Configure_CAN_expansion_board_behaviour"
    }
  ],
  "M970": [
    {
      ...
      "parameters": [
        ...
        {
          "description": " (RRF) 0 = disable, 1 = enable, one value per extruder",
          "label": "En:n:...",
          "optional": true,
          "tag": "E",
          "values": []
  ...
  "M970.3": [
    {
      ...
      "parameters": [
        ...
        {
          "description": " Harmonic of the electrical cycle to correct, 1 to 16",
          "label": "Snn",
          "optional": true,
          "tag": "S",
          "values": []
        ...
        {
          "description": " Correction magnitude in degrees, 0 to 90. J0 removes the correction for that harmonic",
          "label": "Jnnn",
          "optional": true,
          "tag": "J",
          "values": []
        ...
        {
          "description": " Correction phase in degrees, 0 to 360, default 0",
          "label": "Onnn",
          "optional": true,
          "tag": "O",
          "values": []
      ...
      "url": "https://reprap.org/wiki/G-code#M970.3:_Configure_phase_stepping_waveform_correction"
    }
  ],
  "M972": [
    {
  ...
  "METHOD": [
    {
      "brief": "parameter is specified then the default  behavior is for the toolhead to descend until the sensor detects  that the distance to the bed is at or below the",
      "codes": [
        "METHOD"
      ],
      "id": "Klipper.METHOD[0]",
      ...
      "related": [],
      "source": "Klipper",
      "title": "parameter is specified then the default  behavior is for the toolhead to descend until the sensor detects  that the distance to the bed is at or below the",
      "url": "https://www.klipper3d.org/G-Codes.html#probe_eddy_current"
    }
  ],
  "NAME": [
    {
